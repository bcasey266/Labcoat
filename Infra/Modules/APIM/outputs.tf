output "api_admin_consent" {
  ...
  value       = "Please consent to the Service Principal's API Permissions: https://portal.azure.com/#view/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/~/CallAnAPI/appId/${azuread_application.this.application_id}/isMSAApp~/false"
}
